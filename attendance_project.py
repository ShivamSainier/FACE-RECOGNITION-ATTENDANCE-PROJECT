...
path = r'C:\Users\Lenovo\Desktop\FACE RECOGNITION + ATTENDANCE PROJECT\ImagesAttendance'
images = []
classNames = []
...
def markAttendance(name):
    with open(r'C:\Users\Lenovo\Desktop\FACE RECOGNITION + ATTENDANCE PROJECT\Attendance.csv','r+') as f:
